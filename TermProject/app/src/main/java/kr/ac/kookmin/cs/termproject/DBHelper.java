...
class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("Create Table Log(ID INTEGER PRIMARY KEY AUTOINCREMENT, Latitude Real, Longitude Real, CameraPath Text, LogName Text default('실행중'), EventName Text default('실행중'), Note Text default(''), Time Real default (datetime('now','localtime')), Foot Integer default(0), Type Integer default(1), TimeGap Real default(0), NoteName Text default('실행중'))");
